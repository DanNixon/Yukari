...
namespace Yukari
{
  namespace Common
  {
    bool StringParsers::ParseCommand(const std::string & input, std::string & command, std::map<std::string, std::string>& parameters)
    {
    ...
    bool StringParsers::ParseParameterList(const std::string & input, std::map<std::string, std::string>& parameters)
    {
      auto log = LoggingService::Instance().getLogger("StringParsers");
